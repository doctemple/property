...
<h4>แก้ไขข้อมูล</h4>
<br>
                    <form action="api/update.caim.php" method="post" class="needs-validation" novalidate>
                    <input type="hidden" name="caimID" value="<?php echo $caim['caimID']; ?>" >
                ...
                <div class="input-group-prepend">
                  ...
                  <input type="text" class="form-control"  id="fName"  name="fName" value="<?php echo $caim['fName']; ?>"  required>
                </div>
                <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <div class="input-group-text">
                  ...
                  <input type="tel" class="form-control" id="cPhone"  name="cPhone"  value="<?php echo $caim['cPhone']; ?>"  required>
                </div>
                <div class="row">
                  <div class="col-12">
                    <div class="mb-3">
                      <label for="" class="form-label">อธิบาย</label>
                      <textarea class="form-control" id="description" name="description" rows="3" aria-label=""><?php echo $caim['tDescription']; ?></textarea>
                    </div>
                  </div>
                  <!-- /.col -->
                </div>
