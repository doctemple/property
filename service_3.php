...
<div class="page animated bounceInDown">
  ...
  <div class="card">
    ...
    <a class="edit" href="service_edit.php"><i class="fas fa-pencil-alt"></i> แก้ไขข้อมูล</a>
      ...
      <p class="card-text"><strong>ภาพอุปกรณ์</strong> <a class="edit" href="service_2.php"><i class="fas fa-plus-circle"></i> ถ่ายรูปเพิ่ม</a></p>       
                <div class="row">
                    <div class="col-3">
...
<br>
                ...
                <div class="card">
                    <div class="card-body btn-center">
                        <a href="service_wait.php" class="btn btn-success">ยืนยัน ส่งซ่อม</a>
                    </div>
                </div>
