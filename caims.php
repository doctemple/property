...
<div class="page animated bounceInDown">
    <div class="container-fluid">
        ...
        <ul id="progressbar" >
                    ...
                    <form action="api/add.caim.php" method="post" class="needs-validation" novalidate>

                <div class="input-group mb-3">
                <div class="input-group-prepend">
                    <div class="input-group-text">
                    <span class="fas fa-user"></span>&nbsp;สินค้า/รุ่น/ยีห้อ
                    </div>
                  </div>
                ...
                <div class="input-group-prepend">
                    <div class="input-group-text">
                    <span class="fas fa-user"></span>&nbsp;รหัสสินค้า
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="mb-3">
                      <label for="" class="form-label">อาการเสีย</label>
                      <textarea class="form-control" id="description" name="description" rows="2" aria-label=""></textarea>
                    </div>
                  </div>
                  <!-- /.col -->
                </div>
